...
$product_images = '';
if( !empty( $query_post->posts ) ){
  foreach ($query_post->posts as $step_key => $step) {
    $product_img = wc_get_product( $step->ID );
    $product_images .=  '<div class="gray">'. $product_img->get_image().' </div>
    '; 
  }
}
      ...
      <div class="wcmp-vendor-details">
         ...
         <div class="add-call-block">
            ...
            <div class="wcmp-detail-block">
               ...
               <span class="add-address"><?php echo substr($vendor->get_formatted_address(),0,10 ). '..' ; ?>
               </span>
            </div>
            <div class="wcmp-detail-block">
